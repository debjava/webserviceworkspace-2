...
//        		Iterator itr = msgContext.getEnvelope().getHeader().examineAllHeaderBlocks();//extractAllHeaderBlocks();
            	...
            	while( itr.hasNext() )
            	{
            		...
            		if( obj instanceof SOAPHeaderBlock)
            		{
            			...
            			System.out.println(headBlock.getText());
            		}
            		
//            		SoapHeaderElement
//            		SOAPHeaderBlock headBlock = (SOAPHeaderBlock)itr.next();
//            		System.out.println(headBlock.getFirstElement());
//            		System.out.println(headBlock.getChildElements()getLocalName());
            	}
			}
        	catch (Exception e)
			{
        ...
        //
            ...
            private  org.apache.axiom.om.OMElement  toOM(com.ibm.soapheader.Quote_timestamp param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {

            
                        try{
                             return param.getOMElement(com.ibm.soapheader.Quote_timestamp.MY_QNAME,
                                          org.apache.axiom.om.OMAbstractFactory.getOMFactory());
                        } catch(org.apache.axis2.databinding.ADBException e){
                            throw org.apache.axis2.AxisFault.makeFault(e);
                        }
        ...
        */
        ...
        try {
                ...
                if (com.ibm.soapheader.Quote_timestamp.class.equals(type)){
                
                           return com.ibm.soapheader.Quote_timestamp.Factory.parse(param.getXMLStreamReaderWithoutCaching());
